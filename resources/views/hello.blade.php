...
<body class="antialiased">
                    ...
                    <div class="p-6">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                @{{name}} has ----hello {{$name}}----{{ time()}}-----wonderful, thorough documentation covering every aspect of the framework.
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Laravel's robust library of first-party tools and libraries, such as <a href="https://forge.laravel.com"
                                    ...
                                    href="https://nova.laravel.com" class="underline">Nova</a>, and <a href="https://envoyer.io" class="underline">Envoyer</a>
                                help you take your projects to the next level. Pair them with powerful open source libraries like <a
                                    href="https://laravel.com/docs/billing" class="underline">Cashier</a>, <a href="https://laravel.com/docs/dusk"
                                    class="underline">Dusk</a>, <a href="https://laravel.com/docs/broadcasting" class="underline">Echo</a>, <a
                                    href="https://laravel.com/docs/horizon" class="underline">Horizon</a>, <a href="https://laravel.com/docs/sanctum"
    ...
    @if (1)
    <div> You are using Internet Explorer </div>
    @endif
</body>
